...
\location{Grad. May 2009|  Chennai, India}
\sectionsep
...
C++ \textbullet{} Python \textbullet{} MATLAB \textbullet{} \LaTeX\ \\
...
Boost \textbullet{} Intel MPI \textbullet{} Intel OpenMP \\
\sectionsep
...
\runsubsection{Indian Institute of Science}
\descript{| Summer Intern}
\location{May 2012 – July 2012 | Bangalore, India}
\begin{tightemize}
...
\runsubsection{CFD Python Solver}
\descript{| Independent Project }
\location{June 2015 – Present | Gainesville, FL}
\begin{tightemize}
...
\runsubsection{CFD Course Projects}
\descript{| As a part of CFD coursework }
\location{Sep 2015 – Present | Gainesville, FL}
\begin{tightemize}
\item Python based central difference scheme to solve the diffusion equation
\end{tightemize}
\sectionsep
