...
BLOG_AUTHOR = "Sriram Krishnaswamy"  # (translatable)
BLOG_TITLE = "Chuffed to Bits"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://sriramkswamy.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
BASE_URL = "http://sriramkswamy.github.io/blog/"
BLOG_EMAIL = "sriramkswamy@outlook.com"
BLOG_DESCRIPTION = "This is a site about my interests - Engineering, PhD, Programming and Emacs" # (translatable)
